...
/// @file Zbrojni.cpp
/// @brief Plik Ÿród³owy klasy Zbrojni

/// @brief Konstruktor klasy Zbrojni
/// @param x Pozycja x
/// @param y Pozycja y
/// @param arm Nazwa armii
Zbrojni::Zbrojni(int x, int y, string arm)
    :Jednostka(55, 70, 100, 70, x, y, 10, arm, "Zbrojni")
{
...
double Zbrojni::calculateHValue(int row, int col, Pair dest)
{
...
stack <Pair> Zbrojni::aStarSearch(int grid[][COL], int xs, int ys, int xd, int yd)
{
...
bool Zbrojni::isUnBlocked(int grid[][COL], int row, int col)
{
