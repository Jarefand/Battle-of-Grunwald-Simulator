...
/// @file Pospolite_rusz.cpp
/// @brief Plik Ÿród³owy klasy Pospolite_rusz

/// @brief Konstruktor klasy Pospolite_rusz
/// @param x Pozycja x
/// @param y Pozycja y
/// @param arm Nazwa armii
Pospolite_rusz::Pospolite_rusz(int x, int y, string arm)
    :Jednostka(50, 45, 100, 120, x, y, 10, arm, "Pospolite_rusz")
{

}

/// @brief Destruktor klasy Pospolite_rusz
Pospolite_rusz::~Pospolite_rusz()
{
...
double Pospolite_rusz::calculateHValue(int row, int col, Pair dest)
{
...
stack <Pair> Pospolite_rusz::aStarSearch(int grid[][COL], int xs, int ys, int xd, int yd)
{
...
bool Pospolite_rusz::isUnBlocked(int grid[][COL], int row, int col)
{
